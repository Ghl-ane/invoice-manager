    ...
    <div class="grid grid-cols-3 gap-6">
                ...
                <div class="grid grid-cols-3 gap-6 text-sm">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-slate-700">
                            {{ \Carbon\Carbon::parse($invoice->issue_date)->format('M d, Y') }}</p>
                    </div>
                    <div>
                    ...
                    <tbody class="divide-y divide-slate-50">
                        @foreach ($invoice->items as $item)
                            <tr>
                                ...
                                <td class="px-6 py-3 text-right text-slate-500">${{ number_format($item->unit_price, 2) }}
                                </td>
        ...
        <div class="col-span-1 space-y-4">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6 text-center">
                ...
                <span
                    class="mt-2 inline-block px-3 py-1 rounded-full text-xs font-medium {{ $colors[$invoice->status] ?? '' }}">
                    {{ ucfirst($invoice->status) }}
                </span>
            </div>
