...
@section('content')
    ...
    <form action="{{ route('invoices.store') }}" method="POST" id="invoice-form">
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="col-span-2 space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="currency" id="currency-select"
                                class="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent @error('currency') border-red-400 @enderror"
                ...
                {{-- Notes --}}
                <div class="bg-white rounded-xl border border-slate-200 p-6">
                    <h3 class="font-semibold text-slate-700 text-sm mb-4">Notes <span class="text-slate-400 font-normal">(optional)</span></h3>
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-6 sticky top-24">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex justify-between text-sm">
                            ...
                            <span id="summary-subtotal" class="font-medium text-slate-700">
    ...
    <script>
        let itemIndex = 1;
        let currentSymbol = document.querySelector('#currency-select option:checked')?.dataset.symbol ?? '$';
        ...
        function calculateTotal() {
            ...
            document.getElementById('summary-subtotal').querySelector('.currency-symbol').nextSibling.textContent = total.toFixed(2);
            document.getElementById('summary-total').querySelector('.currency-symbol').nextSibling.textContent = total.toFixed(2);
        }
