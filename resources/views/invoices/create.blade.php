        ...
        <div class="bg-white rounded-xl border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="client_id" class="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent @error('client_id') border-red-400 @enderror">
