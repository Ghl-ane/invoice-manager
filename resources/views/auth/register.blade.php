    ...
    <div class="flex min-h-screen items-center justify-center bg-gray-100">
        <div class="flex w-full max-w-3xl rounded-2xl overflow-hidden shadow-lg">
            ...
            <div class="flex-1 bg-white px-10 py-10">
                ...
                <p class="text-sm text-gray-500 mb-6">Start managing your invoices</p>
                ...
                <form method="POST" action="{{ route('register') }}" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('password', 'eye-pass')"
                                class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-[#f5a623] transition-colors">
                                <svg id="eye-pass" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                    ...
                    <p class="text-center text-sm text-gray-500 mt-4">
                        Already registered?
                        <a href="{{ route('login') }}" class="text-[#f5a623] hover:underline">Log in →</a>
                    </p>
