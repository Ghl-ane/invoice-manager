            ...
            <div class="flex-1 bg-white px-10 py-10">
                ...
                <form method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('password', 'eye-login')"
                                ...
                                <svg id="eye-login" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <label for="remember_me" class="inline-flex items-center cursor-pointer">
                            <input id="remember_me" type="checkbox" name="remember"
                                class="rounded border-gray-300 text-[#f5a623] shadow-sm focus:ring-[#f5a623]" />
                            <span class="ms-2 text-sm text-gray-600">{{ __('Remember me') }}</span>
                        </label>

                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-[#f5a623] hover:underline">
                    ...
                    <p class="text-center text-sm text-gray-500 mt-4">
                        ...
                        <a href="{{ route('register') }}" class="text-[#f5a623] hover:underline">Sign up now →</a>
                    </p>
